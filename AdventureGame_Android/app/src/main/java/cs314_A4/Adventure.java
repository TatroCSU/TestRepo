...
- Code is put into package cs314_A1 to match current CS314 coding standards.
Updated January 2012
- Renamed as the "Adventure Game"
Updated Jan 2016 - gg
- took out comments on how to compile and run

**** NO LONGER VALID To compile: javac cs314_A1.AdventureGame.java
**** NO LONGER VALID To run:     java cs314_A1.AdventureGame
 ...
 * Changed all instances of cs314.a2 to cs314_A1
 * @author bhamor
 *
 */
...
public class Adventure {
  ...
  // Creates 11 rooms each with their own entrance, descriptions, items, and exit
  ...
  // Room 9:
     Room r9 = new Room();
     r9.setDesc("This room is so Scarry! So horrible! We do not DARE to describe it!"
     		+ " It is the room that has no name, we will only refer to it as R9!");
